<?php
$app->post('/api/Unsplash/createCollection', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'title']);
    ...
    if (!empty($post_data['args']['private'])) {
        $body['private'] = $post_data['args']['private'];
    }
